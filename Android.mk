...
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: questui - version: 0.6.6
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"Tweakaroo"' -DVERSION='"2.0.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
